...
plt0.scatter(terms[0], freqs[0])
plt99.scatter(terms[int(size/4)], freqs[int(size/4)])
plt499.scatter(terms[int(size/2)], freqs[int(size/2)])
plt999.scatter(terms[-1], freqs[-1])
